...
/**
 * A DTO for the {@link cn.dgd.zdw.domain.TSysNotice} entity.
 */
@ApiModel(description = "通知公告表")
public class TSysNoticeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TSysNoticeDTO)) {
            return false;
        }

        return id != null && id.equals(((TSysNoticeDTO) o).id);
    }
