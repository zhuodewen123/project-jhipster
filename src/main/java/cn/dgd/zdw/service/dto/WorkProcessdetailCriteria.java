...
/**
 * Criteria class for the {@link cn.dgd.zdw.domain.WorkProcessdetail} entity. This class is used
 * in {@link cn.dgd.zdw.web.rest.WorkProcessdetailResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /work-processdetails?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class WorkProcessdetailCriteria implements Serializable, Criteria {
    ...
    public WorkProcessdetailCriteria() {
    }

    public WorkProcessdetailCriteria(WorkProcessdetailCriteria other) {
    ...
    @Override
    public WorkProcessdetailCriteria copy() {
        return new WorkProcessdetailCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final WorkProcessdetailCriteria that = (WorkProcessdetailCriteria) o;
        return
    ...
    public String toString() {
        return "WorkProcessdetailCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
