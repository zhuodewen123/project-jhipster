...
/**
 * Criteria class for the {@link cn.dgd.zdw.domain.WorkProcess} entity. This class is used
 * in {@link cn.dgd.zdw.web.rest.WorkProcessResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /work-processes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class WorkProcessCriteria implements Serializable, Criteria {
    ...
    public WorkProcessCriteria() {
    }

    public WorkProcessCriteria(WorkProcessCriteria other) {
    ...
    @Override
    public WorkProcessCriteria copy() {
        return new WorkProcessCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final WorkProcessCriteria that = (WorkProcessCriteria) o;
        return
