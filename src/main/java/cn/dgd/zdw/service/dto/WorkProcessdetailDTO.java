...
/**
 * A DTO for the {@link cn.dgd.zdw.domain.WorkProcessdetail} entity.
 */
@ApiModel(description = "办事明细表")
public class WorkProcessdetailDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkProcessdetailDTO)) {
            return false;
        }

        return id != null && id.equals(((WorkProcessdetailDTO) o).id);
    }
