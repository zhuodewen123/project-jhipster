...
/**
 * A DTO for the {@link cn.dgd.zdw.domain.SysWorkProcessdetail} entity.
 */
@ApiModel(description = "办事明细表")
public class SysWorkProcessdetailDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SysWorkProcessdetailDTO)) {
            return false;
        }

        return id != null && id.equals(((SysWorkProcessdetailDTO) o).id);
    }
    ...
    public String toString() {
        return "SysWorkProcessdetailDTO{" +
            "id=" + getId() +
