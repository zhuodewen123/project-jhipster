...
/**
 * Criteria class for the {@link cn.dgd.zdw.domain.SysNotice} entity. This class is used
 * in {@link cn.dgd.zdw.web.rest.SysNoticeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sys-notices?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class SysNoticeCriteria implements Serializable, Criteria {
    ...
    public SysNoticeCriteria() {
    }

    public SysNoticeCriteria(SysNoticeCriteria other) {
    ...
    @Override
    public SysNoticeCriteria copy() {
        return new SysNoticeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SysNoticeCriteria that = (SysNoticeCriteria) o;
        return
