 ...
 */
@Entity
@Table(name = "t_sys_work_processdetail")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class TSysWorkProcessdetail implements Serializable {
    ...
    public TSysWorkProcessdetail fkWorkProcessId(String fkWorkProcessId) {
    ...
    public TSysWorkProcessdetail todoOrg(String todoOrg) {
    ...
    public TSysWorkProcessdetail result(String result) {
        this.result = result;
        return this;
    }
    ...
    public TSysWorkProcessdetail approvalComments(String approvalComments) {
    ...
    public TSysWorkProcessdetail receiveTime(LocalDate receiveTime) {
    ...
    public TSysWorkProcessdetail approvalTime(LocalDate approvalTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TSysWorkProcessdetail)) {
            return false;
        }
        return id != null && id.equals(((TSysWorkProcessdetail) o).id);
    }
