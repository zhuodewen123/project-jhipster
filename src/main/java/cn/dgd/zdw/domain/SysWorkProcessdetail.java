 ...
 */
@Entity
@Table(name = "sys_work_processdetail")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class SysWorkProcessdetail implements Serializable {
    ...
    public SysWorkProcessdetail fkWorkProcessId(String fkWorkProcessId) {
    ...
    public SysWorkProcessdetail todoOrg(String todoOrg) {
    ...
    public SysWorkProcessdetail result(String result) {
        this.result = result;
        return this;
    }
    ...
    public SysWorkProcessdetail approvalComments(String approvalComments) {
    ...
    public SysWorkProcessdetail receiveTime(LocalDate receiveTime) {
    ...
    public SysWorkProcessdetail approvalTime(LocalDate approvalTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SysWorkProcessdetail)) {
            return false;
        }
        return id != null && id.equals(((SysWorkProcessdetail) o).id);
    }
