...
public class SysNotice implements Serializable {
    ...
    public SysNotice sender(String sender) {
        this.sender = sender;
        return this;
    }
    ...
    public SysNotice sendDate(String sendDate) {
    ...
    public SysNotice receiver(LocalDate receiver) {
    ...
    public SysNotice auditOrg(LocalDate auditOrg) {
    ...
    public SysNotice delFlag(String delFlag) {
